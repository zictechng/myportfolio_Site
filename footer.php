               ...
               <div class="row align-items-center">
                  <div class="col-xl-7 col-lg-7 col-md-7 col-12">
                     <div class="tp-footer-top">
                        <h5 class="tp-footer-title">More than 6 years of industry experience <br> client satisfactory is my goal.
                           🤝</h5>
                  ...
                  <div class="row align-items-center">
                     <div class="col-xl-5 col-lg-5 col-md-5 col-12">
                        <div class="tp-copyright-text z-index-1">
                           <p class="m-0">© <?php echo (date('Y'))?> Abel Portfolio , All Right Reserved.</p>
                        </div>
                     </div>
                     <div class="col-xl-7 col-lg-7 col-md-7 col-12">
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                        <div class="tp-copyright-social text-md-end mt-25">
                           <a href="https://www.linkedin.com/in/abel-uwadia" target='_new'><i class="fab fa-linkedin-in"></i></a>
                           <a href="https://www.facebook.com/profile.php?id=61550345348900" target='_new'><i class="fab fa-facebook-f"></i></a>
                           <a href="https://www.youtube.com/channel/UCC8gAzkssMVDWKzwLEkS8KA" target='_new'><i class="fab fa-youtube"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
